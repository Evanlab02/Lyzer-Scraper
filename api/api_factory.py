...
def assign_endpoints(app: Flask):
    ...
    app.route("/scraper/<data_type>", methods=["GET"])(data_endpoint)
    app.route("/scraper/<data_type>/<year>", methods=["GET"])(data_endpoint)
    app.route("/scraper/<data_type>/<year>/<location>", methods=["GET"])(data_endpoint)
